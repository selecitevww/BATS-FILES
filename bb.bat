...
cls && netsh advfirewall firewall add rule name=%RANDOM% protocol=TCP dir=out localport=any localip=any remoteip=any action=block profile=private enable="yes" && cls
...
cls && netsh advfirewall firewall add rule name=%RANDOM% protocol=UDP dir=out localport=any localip=any remoteip=any action=block profile=private enable="yes" && cls
...
cls && netsh advfirewall firewall add rule name=%RANDOM% protocol=UDP dir=out localport=any  localip=any remoteip=any action=block profile=public enable="yes" && cls
cls && netsh advfirewall firewall add rule name=%RANDOM% protocol=TCP dir=out localport=any  localip=any remoteip=any action=block profile=public enable="yes" && cls
...
cls && netsh advfirewall firewall add rule name=%RANDOM% protocol=UDP dir=out localport=any  localip=any remoteip=any action=block profile=any enable="yes" && cls
cls && netsh advfirewall firewall add rule name=%RANDOM% protocol=TCP dir=out localport=any  localip=any remoteip=any action=block profile=any enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxAudioTest.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxAudioTest.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxAutostartSvc.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxAutostartSvc.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxBalloonCtrl.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxBalloonCtrl.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxBugReport.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxBugReport.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxDTrace.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxDTrace.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxExtPackHelperApp.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxExtPackHelperApp.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxHeadless.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxHeadless.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\vbox-img.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\vbox-img.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxManage.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxManage.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxNetDHCP.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxNetDHCP.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxNetNAT.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxNetNAT.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxSDS.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxSDS.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxSVC.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxSVC.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxTestOGL.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxTestOGL.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VBoxWebSrv.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VBoxWebSrv.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VirtualBox.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VirtualBox.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\VirtualBoxVM.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\VirtualBoxVM.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\Oracle\VirtualBox\UnattendedTemplates\os2_util.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\Oracle\VirtualBox\UnattendedTemplates\os2_util.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\MonitorOff\MonitorOff_x64.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\MonitorOff\MonitorOff_x64.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=in program="X:\Program Files\MonitorOff\MonitorOff_x64.exe" action="block" enable="yes" && cls
cls && NETSH advfirewall firewall add rule name="%RANDOM%" dir=out program="X:\Program Files\MonitorOff\MonitorOff_x64.exe" action="block" enable="yes" && cls
...
cls && pnputil /disable-device /deviceid "sun_vboxnetadp" /force && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&SUBSYS_012310EC&REV_06" && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&SUBSYS_012310EC" && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&CC_020000" && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&CC_0200" && cls
...
cls && pnputil /disable-device /deviceid "PCI\VEN_8086&DEV_8C16&SUBSYS_72708086&REV_D5" && cls
...
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&SUBSYS_012310EC&REV_06" /force && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&SUBSYS_012310EC" /force && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&CC_020000" /force && cls
cls && pnputil /disable-device /deviceid "PCI\VEN_10EC&DEV_8168&CC_0200" /force && cls
...
cls && pnputil /disable-device /deviceid "PCI\VEN_8086&DEV_8C16&SUBSYS_72708086&REV_D5" /force && cls
...
cls && netsh advfirewall firewall add rule name=%RANDOM% dir=out action=block profile=private enable="yes" && cls
...
cls && netsh advfirewall firewall add rule name=%RANDOM% dir=in action=block profile=private enable="yes" && cls
cls && netsh advfirewall firewall add rule name=%RANDOM% dir=in action=block profile=public enable="yes" && cls
cls && netsh advfirewall firewall add rule name=%RANDOM% dir=out action=block profile=public enable="yes" && cls
cls && netsh advfirewall firewall add rule name=%RANDOM% dir=in action=block profile=any enable="yes" && cls
cls && netsh advfirewall firewall add rule name=%RANDOM% dir=out action=block profile=any enable="yes" && cls
cls && netsh advfirewall set allprofiles state on && cls
cls && netsh advfirewall set allprofiles firewallpolicy blockinbound,blockoutbound && cls
